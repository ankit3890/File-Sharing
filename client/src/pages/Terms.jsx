...
const Terms = () => {
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '800px', margin: '0 auto', color: '#cbd5e1' }}>
            <button 
                onClick={handleBack} 
                style={{ 
                    display: 'flex', 
            ...
            >
                ...
                <p style={{ marginBottom: '2rem', fontStyle: 'italic', color: '#94a3b8' }}>Last Updated: {currentDate}</p>

                <div className="glass" style={{ padding: '2.5rem', borderRadius: '1.5rem', lineHeight: '1.7', background: 'rgba(15, 23, 42, 0.6)' }}>
